...
module top ;
    ...
    UART_v2_50_0 UART (
        ...
        .rx_clk(Net_1482),
        .rx_data(Net_1483),
        .rx_interrupt(Net_1484),
        .tx(Net_1485),
        .tx_clk(Net_1486),
        .tx_data(Net_1487),
        .tx_en(Net_1488),
        .tx_interrupt(Net_1489));
	...
	wire [0:0] tmpOE__MotorPWM_net;
	wire [0:0] tmpFB_0__MotorPWM_net;
	wire [0:0] tmpIO_0__MotorPWM_net;
	wire [0:0] tmpINTERRUPT_0__MotorPWM_net;
	electrical [0:0] tmpSIOVREF__MotorPWM_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		MotorPWM
		 (.oe(tmpOE__MotorPWM_net),
		  .y({Net_234}),
		  .fb({tmpFB_0__MotorPWM_net[0:0]}),
		  .io({tmpIO_0__MotorPWM_net[0:0]}),
		  .siovref(tmpSIOVREF__MotorPWM_net),
		  .interrupt({tmpINTERRUPT_0__MotorPWM_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MotorPWM_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    PWM_v3_30_1 MotorA_PWM (
        .capture(1'b0),
        .clock(Net_227),
        .cmp_sel(1'b0),
        .enable(1'b1),
	...
	cy_clock_v1_0
		#(.id("e3c3ba3b-46a3-409a-af3c-82014e9727c9"),
	...
	wire [1:0] tmpOE__Encoder_net;
	wire [1:0] tmpIO_1__Encoder_net;
	wire [0:0] tmpINTERRUPT_0__Encoder_net;
	electrical [0:0] tmpSIOVREF__Encoder_net;
	...
	cy_psoc3_pins_v1_10
		...
		Encoder
		 (.oe(tmpOE__Encoder_net),
		  .y({2'b0}),
		  .fb({Net_170, Net_169}),
		  .io({tmpIO_1__Encoder_net[1:0]}),
		  .siovref(tmpSIOVREF__Encoder_net),
		  .interrupt({tmpINTERRUPT_0__Encoder_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Encoder_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{2'b11} : {2'b11};

    QuadDec_v3_0_4 MotorA_QuadDec (
        .clock(Net_172),
        .index(1'b0),
        .interrupt(Net_173),
        .quad_A(Net_169),
	...
	cy_psoc3_pins_v1_10
		#(.id("2e86567d-eed0-4971-a7b1-6426e614aaa8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("606346f0-89bf-47b6-ae51-668da802bb2c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("aac164e0-e346-4e07-bcb3-6b5728f00b99"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
